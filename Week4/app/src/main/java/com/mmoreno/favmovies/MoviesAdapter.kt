...
class MoviesAdapter(
    ...
    /**
     * Custom method for responding on a swipe event
     * to delete a movie
     * @param position of the list, that corresponds to our
     * Data Repository
     * @return [Unit]
     */
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        fun bind(movie: Movie) {
            itemView.movieTitle.text = itemView.context.getString(movie.title)
            ...
            itemView.movieGenre.text = itemView.context.getString(movie.genre)
         ...
         * @param view object that responds to the event
         * @return [Unit]
         */
        override fun onClick(v: View?) {
            movieItemListener.openMovieDetailFragment(adapterPosition)
        }
    }
    ...
    interface OnMovieClickListener {
        fun openMovieDetailFragment(position: Int)
    }
